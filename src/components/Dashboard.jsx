...
const Dashboard = ({ positions, onNewTradeClick, onEditPosition, onDeletePosition, onClosePosition, onAssignPosition, onExpirePosition, onRollPosition }) => {
